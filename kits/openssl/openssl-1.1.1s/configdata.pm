...
our %config = (
  ...
  conf_files => [ "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/00-base-templates.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/10-main.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  prefix => "/mnt/local/1tb/job/private/coding/github/octopus/sysroot//x86_64//",
  processor => "",
...
our %target = (
  ...
  RANLIB => "ranlib",
  RC => "windres",
  _conf_fname_int => [ "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/00-base-templates.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/00-base-templates.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/10-main.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/10-main.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/00-base-templates.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/10-main.conf", "/mnt/local/1tb/job/private/coding/github/octopus/kits/openssl/openssl-1.1.1s/Configurations/shared-info.pl" ],
