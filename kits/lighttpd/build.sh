...
#检查是否已经创建。
if [ ! -f ${STAPLER_TARGET_PREFIX_PATH}/sbin/lighttpd ];then
{
    #临时目录。
    BUILD_TMP_PATH=${STAPLER_BUILD_PATH}/lighttpd/
    #删除过时的配置。
    ...
    #执行配置。
    ${STAPLER_NATIVE_PREFIX_PATH}/bin/cmake ${LIGHTTPD_SRC_PATH} \
        ...
        -DCMAKE_RANLIB=${STAPLER_TARGET_COMPILER_RANLIB} \
        ...
        -DCMAKE_C_FLAGS="-O3 -I${STAPLER_TARGET_PREFIX_PATH}/include/ -L${STAPLER_TARGET_PREFIX_PATH}/lib" \
        -DCMAKE_CXX_FLAGS="-O3 -I${STAPLER_TARGET_PREFIX_PATH}/include/ -L${STAPLER_TARGET_PREFIX_PATH}/lib" \
