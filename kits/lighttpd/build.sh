...
#检查是否已经创建。
if [ ! -f ${TARGET_PREFIX_PATH}/sbin/lighttpd ];then
{
    #临时目录。
    ...
    #执行配置。
    ${NATIVE_PREFIX_PATH}/bin/cmake ${LIGHTTPD_SRC_PATH} \
        ...
        -DCMAKE_C_FLAGS="-O3 -I${TARGET_PREFIX_PATH}/include/ -L${TARGET_PREFIX_PATH}/lib" \
        -DCMAKE_CXX_FLAGS="-O3 -I${TARGET_PREFIX_PATH}/include/ -L${TARGET_PREFIX_PATH}/lib" \
