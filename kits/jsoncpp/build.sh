...
#检查是否已经创建。
if [ ! -f ${TARGET_PERFIX_PATH}/lib/libjsoncpp.so ] && [ ! -f ${TARGET_PERFIX_PATH}/lib64/libjsoncpp.so ] ;then
{
    #临时目录。
    BUILD_TMP_PATH=${BUILD_PATH}/jsoncpp/
    #删除过时的配置。
