...
#检查是否已经创建。
if [ ! -f ${TARGET_PERFIX_PATH}/include/eigen3/Eigen/Core ];then
{
    #临时目录。
    ...
    #执行配置。
    ${NATIVE_PERFIX_PATH}/bin/cmake ${EIGEN_SRC_PATH} \
        ...
        -DCMAKE_Fortran_COMPILER=${TARGET_COMPILER_PREFIX}gfortran \
