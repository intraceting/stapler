...
#检查是否已经创建。
if [ ! -f ${STAPLER_TARGET_PREFIX_PATH}/include/eigen3/Eigen/Core ];then
{
    #临时目录。
    BUILD_TMP_PATH=${STAPLER_BUILD_PATH}/eigen/
    #删除过时的配置。
    ...
    #执行配置。
    ${STAPLER_NATIVE_PREFIX_PATH}/bin/cmake ${EIGEN_SRC_PATH} \
        ...
        -DCMAKE_Fortran_COMPILER=${STAPLER_TARGET_COMPILER_FORTRAN} \
